...
public class GameRenderer {
    ...
    private TextureRegion bg, grass,dirt, birdMid, skullUp, skullDown, bar, ready,
    ...
    private void drawDirt() {
        batcher.draw(dirt, frontDirt.getX(), frontDirt.getY(),
                frontDirt.getWidth(), frontDirt.getHeight());
        batcher.draw(dirt, backDirt.getX(), backDirt.getY(),
                backDirt.getWidth(), backDirt.getHeight());
    }
    ...
    private void drawMenuUI() {
        batcher.draw(zbLogo, 136 / 2 - 56, midPointY - 90,
    ...
    public void render(float delta, float runTime) {
        ...
        batcher.draw(bg, 0, 0, 250, midPointY + 122);
